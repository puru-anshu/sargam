...
public class BindingAdapters {
	...
	public static void setAlbumArt(ImageView imageView, long albumId) {
		Glide.with(imageView.getContext()).load(Util.getAlbumArtUri(albumId))
	...
	public static void setImageUrl(ImageView imageView, String url) {
		...
		Glide.with(context).load(url)
				.error(R.drawable.music_note).into(imageView);
	}
