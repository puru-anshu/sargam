package com.arutech.sargam.utils.compat;
...
import static com.arutech.sargam.data.annotations.PrimaryTheme.CYAN;
import static com.arutech.sargam.data.annotations.StartPage.SONGS;
...
public class JockeyPreferencesCompat {
    ...
    private static void updateFromJockey2_0(Context context) {
        ...
        preferenceStore.setAccentColor(preferenceStore.getAccentColor());
    }
