...
import com.arutech.sargam.data.store.RemotePreferenceStore;
...
public class MusicPlayer implements AudioManager.OnAudioFocusChangeListener,
	 ...
	 */
	public static final String UPDATE_BROADCAST = "com.arutech.sargam.player.REFRESH";
	 ...
	 * by the user).
	 */
	public static final String UPDATE_EXTRA_MINOR = "com.arutech.sargam.player.REFRESH:minor";
	 ...
	 */
	public static final String INFO_BROADCAST = "com.arutech.sargam.player.INFO";

	/**
	 * An {@link Intent} extra sent with {@link #INFO_BROADCAST} intents which maps to a
	 * user-friendly information message
	 */
	public static final String INFO_EXTRA_MESSAGE = "com.arutech.sargam.player.INFO:MSG";
	 ...
	 * @see #ERROR_EXTRA_MSG
	 */
	public static final String ERROR_BROADCAST = "com.arutech.sargam.player.ERROR";

	/**
	 * An {@link Intent} extra sent with {@link #ERROR_BROADCAST} intents which maps to a
	 * user-friendly error message
	 */
	public static final String ERROR_EXTRA_MSG = "com.arutech.sargam.player.ERROR:MSG";
