package com.arutech.sargam.dialog;
...
import com.arutech.sargam.widgets.CircularSeekBar;
...
public class DurationPickerDialogFragment extends DialogFragment
    ...
    private CircularSeekBar mSlider;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mSlider = (CircularSeekBar) contentView.findViewById(R.id.duration_picker_slider);
    ...
    @Override
    public void onProgressChanged(CircularSeekBar seekArc, int progress, boolean fromUser) {
        mOffsetValue = progress + mMinValue;
        mLabel.setText(getString(R.string.time_in_min_format, mOffsetValue));
    }

    @Override
    public void onStartTrackingTouch(CircularSeekBar seekArc) {

    }

    @Override
    public void onStopTrackingTouch(CircularSeekBar seekArc) {
