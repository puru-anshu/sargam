...
import com.arutech.sargam.databinding.FragmentNowPlayingBinding;
...
import com.arutech.sargam.dialog.DurationPickerDialogFragment;
import com.arutech.sargam.dialog.NumberPickerDialogFragment;
...
import com.arutech.sargam.view.TimeView;
...
public class NowPlayingFragment extends BaseFragment
	...
	//	private NowPlayingNewBinding mBinding;
	...
	private Disposable mSleepTimerSubscription;
	...
	private void updateSleepTimerCounter(long endTimestamp) {
		...
		if (mSleepTimerSubscription != null) {
			mSleepTimerSubscription.dispose();
		}
	...
	private void clearQueue() {
		mPlayerController.getPlayerState()
				.compose(this.<PlayerState>bindToLifecycle())
				.subscribe(
						new SingleObserver<PlayerState>() {
							@Override
							...
							@Override
							public void onSuccess(@NonNull PlayerState playerState) {
