...
import com.arutech.sargam.player.PlayerService;
...
import static com.arutech.sargam.data.annotations.BaseTheme.AUTO;
import static com.arutech.sargam.data.annotations.BaseTheme.DARK;
import static com.arutech.sargam.data.annotations.BaseTheme.LIGHT;
...
public class PresetThemeStore implements ThemeStore {
    ...
    public void createThemedLauncherIcon() {
        ...
        String launchActivityName = "com.arutech.sargam.activity.LibraryActivity";
